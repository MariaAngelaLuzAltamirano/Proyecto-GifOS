...
let textUser;
let idCard;
let eliCard = document.getElementById('eli');
...
btnVerMasMisGifos.addEventListener('click', () =>{
    ...
    if(gifmisGifos.length < (contadorVermasMisGifos +8)){
        ...
        for (var i = gifmisGifos.length; i < (contadorVermasMisGifos +8); i++) {
    ...
    misGifos.insertBefore(nuevaGrilla, btnVerMasMisGifos);
    contadorVermasMisGifos+= 8;
...
//funcion que llamo en el Onclick de anchor de Favoritos
